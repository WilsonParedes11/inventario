...
class TrakingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $movements = [];
        if ($request->has('selectedProductId')) {
            $traking = Product::find($request->selectedProductId);
            $movements = $traking->movements;
        }
        return view('traking.index', [
            'products' => $products,
            'movements' => $movements,
        ]);
    }
