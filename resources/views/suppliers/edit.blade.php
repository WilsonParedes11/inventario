                                ...
                                <div class="card-body">
                                    <div class="row row-cards">
                                        <div class="col-md-12">
                                            ...
                                            <x-input name="shopname" label="Nombre del Negocio" :value="old('shopname', $supplier->shopname)"
                                                :required="true" />
                                            <x-input name="phone" label="Telefono" :value="old('phone', $supplier->phone)" :required="true" />
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            ...
                                            <select class="form-select @error('bank_name') is-invalid @enderror"
                                                ...
                                                <option value="Pichincha"
                                                    @if (old('bank_name', $supplier->bank_name) == 'Pichincha') selected="selected" @endif>Pichincha
                                                </option>
                                                <option value="Guayaquil"
                                                    @if (old('bank_name', $supplier->bank_name) == 'Guayaquil') selected="selected" @endif>Guayaquil
                                                </option>
                                                <option value="Bolivariano"
                                                    @if (old('bank_name', $supplier->bank_name) == 'Bolivariano') selected="selected" @endif>Bolivariano
                                                </option>
                                                <option value="Produbanco"
                                                    @if (old('bank_name', $supplier->bank_name) == 'Produbanco') selected="selected" @endif>Produbanco
                                                </option>
                                                <option value="Pacifico"
                                                    @if (old('bank_name', $supplier->bank_name) == 'Pacifico') selected="selected" @endif>Pacifico
                                                </option>
                                                <option value="BanEcuador"
                                                    @if (old('bank_name', $supplier->bank_name) == 'BanEcuador') selected="selected" @endif>BanEcuador
                                                </option>
                                            </select>
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            <x-input name="account_holder" label="Titular de la cuenta" :value="old('account_holder', $supplier->account_holder)" />
                                        </div>
                                        <div class="col-sm-6 col-md-6">
                                            <x-input name="account_number" label="Número de cuenta" :value="old('account_number', $supplier->account_number)" />
                                        </div>
